/**
 * Compliance Advisor — Multi-turn Claude Conversation
 * ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 ...
 * - Full ORIENT context awareness (risk level, obligations, assessment, etc.)
 * - Conversation persistence (reload-safe)
 * - Collapsible panel (doesn't block workflow)
 * - Suggested questions per ORIENT step
 */
...
export function ComplianceAdvisor({ systemId, orientStep, contextHint }: AdvisorProps) {
  ...
  const sendMessage = useCallback(
    ...
    [systemId, orientStep, contextHint, conversationId, messages.length, loading]
  );
  ...
  // ━━━ ADVISOR PANEL ━━━
  return (
    <div className="fixed bottom-6 right-6 z-50 w-[420px] max-h-[600px] flex flex-col bg-[#16181C] border border-[rgba(232,230,226,0.10)]">
      {/* Header */}
      ...
      <div className="flex-1 overflow-y-auto px-4 py-3 space-y-3 min-h-[200px] max-h-[400px]">
        ...
        {loading && (
          <div className="flex items-center gap-2 px-3 py-2">
            ...
            <span className="text-[10px] text-[#8A8884]">Thinking...</span>
          </div>
        )}
