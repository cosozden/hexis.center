...
export default async function DashboardPage() {
  ...
  return (
    <div className="max-w-5xl">
      {/* Welcome header — brass underline */}
      <div className="mb-8">
        <h1 className="hexis-section-title text-2xl text-dark-type">
          AI Governance Overview
        </h1>
        <p className="text-dark-sub mt-3">
          Track your EU AI Act compliance across all systems.
        </p>
      </div>

      {/* Metric cards — brass top border for featured look */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <div className="hexis-card-featured">
          <p className="label-upper mb-2">AI Systems</p>
          <p className="hexis-metric text-3xl">
            {systemCount ?? 0}
          </p>
        ...
        <div className="hexis-card-featured">
          ...
          <p className="hexis-metric text-3xl">—</p>
      ...
      {/* Empty state — call to action with brass left accent */}
      {(systemCount ?? 0) === 0 && (
        <div className="hexis-card-accent text-center py-12">
